...
function flower_shop_lite_register_required_plugins() {
	...
	function remove_flower_shop_lite_sidebars() {
    unregister_sidebar('sidebar-1'); // Désenregistre la sidebar principale
}
add_action('widgets_init', 'remove_flower_shop_lite_sidebars', 11);
